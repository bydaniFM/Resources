    ...
    namespace example
    {
        ...
        public:
            ...
            struct Pixel
            {
                ...
                int get_red   () const { return (value >>  7) & 0xf8;    }
                int get_green () const { return (value >>  2) & 0xf8;    } 
                int get_blue  () const { return (value <<  3) & 0xf8;    }
                int get_alpha () const { return (value >> 15) ? 255 : 0; }
        ...
        public:
            ...
            Pixel_Buffer::Color get_color (size_t offset) const
            {
                Pixel  pixel = buffer[offset];

                return Pixel_Buffer::Color(pixel.get_red (), pixel.get_green (), pixel.get_blue (), pixel.get_alpha ());
            }
